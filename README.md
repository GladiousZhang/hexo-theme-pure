...
## 本项目新增
谷歌、微软的seo：在pure/layout/_common/head.ejs下修改对应内容为你的apikey

![image-20240802111146221](README/image-20240802111146221.png)

优化国际版valine无法访问的问题：

在pure/_config.yml下上传serverURLs

![image-20240802111429319](README/image-20240802111429319.png)
